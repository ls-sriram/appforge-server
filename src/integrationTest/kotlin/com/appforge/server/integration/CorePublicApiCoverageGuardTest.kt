...
class CorePublicApiCoverageGuardTest {
    ...
    private val expected = setOf(
        ...
        "POST /api/v1/entities/{type}/{id}/collaborator-shares",
        "GET /api/v1/entities/{type}/{id}/collaborator-shares",
        "POST /api/v1/entities/shares/{token}/revoke",
        "POST /api/v1/entities/{type}/{id}/shares/{token}/email",
        "POST /api/v1/collaborator-shares/{shareId}/revoke",
        "GET /api/v1/collaborator/shares",
        "GET /api/v1/collaborator/shares/{shareId}",
        "GET /api/v1/collaborator/shares/{shareId}/review-template",
        "POST /api/v1/collaborator/shares/{shareId}/reviews",
        "GET /shares/{token}",
