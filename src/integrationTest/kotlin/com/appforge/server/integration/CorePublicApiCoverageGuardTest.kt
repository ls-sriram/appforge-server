...
class CorePublicApiCoverageGuardTest {
    ...
    private val expected = setOf(
        ...
        "POST /api/v1/entities/{type}/{id}/reviewer-shares",
        "GET /api/v1/entities/{type}/{id}/reviewer-shares",
        "POST /api/v1/entities/shares/{token}/revoke",
        "POST /api/v1/entities/{type}/{id}/shares/{token}/email",
        "POST /api/v1/reviewer-shares/{shareId}/revoke",
        "GET /api/v1/reviewer/shares",
        "GET /api/v1/reviewer/shares/{shareId}",
        "GET /api/v1/reviewer/shares/{shareId}/review-template",
        "POST /api/v1/reviewer/shares/{shareId}/reviews",
        "GET /shares/{token}",
